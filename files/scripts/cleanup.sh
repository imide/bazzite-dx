...
#sed -i 's@enabled=1@enabled=0@g' /etc/yum.repos.d/mullvad-stable.repo
#sed -i 's@enabled=1@enabled=0@g' /etc/yum.repos.d/brave-browser.repo
#sed -i 's@enabled=1@enabled=0@g' /etc/yum.repos.d/1password.repo # TODO: see if this actually matters lol
